<main class="container-fluid" style="height: 100vh;">
    <div class="row" style="height: 100vh;">
        <div class="col-lg-7 text-md-center text-lg-start d-flex justify-content-center align-items-center flex-column position-relative" style="height: 100vh;">
            <div>
                <div>
                    <h1 class="h1">Pulih lebih cepat <br>bangkit lebih kuat!</h1>
                </div>
